...
//		
		...
		tablespDonHang.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				maspdh.setText(modeldssanphamthemcongdoan.getValueAt(row, 1).toString());
				tenspdh.setText(modeldssanphamthemcongdoan.getValueAt(row, 2).toString());
...
//				    	madonhang.setText(result);
				...
				//
				dhdao.insertDonhang(dh);
				cddhdao.themCongDoanDonHang(matiep);
...
//		             
		...
		cbotencd.addItem("Hoàn thành đôi giày");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedTrinhDo != null) {
                    if (selectedTrinhDo.equals("Gia công")) {
                    	...
                    	else if (selectedTrinhDo.equals("Hoàn thành đôi giày")) {
...
//					
					...
					cddao.updateCongDoan(giacd, macd);
		        ...
		        if (!e.getValueIsAdjusting()) {
		            ...
		            if (selectedRow != -1) {
		            	modeldssanphamthemcongdoan.getValueAt(selectedRow,  1).toString();
		            	 ...
		            	 List<CongDoan> loadcdtheosp=cddao.getAllcongdoantheosanpham(modeldssanphamthemcongdoan.getValueAt(selectedRow,  1).toString());
		    ...
		    public void valueChanged(ListSelectionEvent e) {
		        if (!e.getValueIsAdjusting()) {
		            ...
		            if (selectedRow != -1) {
		         		...
		         		for (BangPhanCong bpc : bpcdao.DSPC(modelcongdoanphancong.getValueAt(selectedRow,  0).toString())) {
		         			Boolean lun = null;
		         			String slpc="";
				    ...
				    if (trangthaicheck != null && trangthaicheck) {
				        ...
				        if (value == null || value.toString().isEmpty()) {
				            ...
				            if (soluongphancong < 100) {
				                ...
				                if (sum > bpcdao.tongsoluongphancong(maCongDoan)) {
				                	...
				                	cccndao.themChamCongCongNhan(cccn);
				                }
...
//			            	 List<BangPhanCong> dspc=bpcdao.DSPC( );
			         		...
			         		for (BangPhanCong bpc : bpcdao.DSPC(modelcongdoanphancong.getValueAt(selectedRow,  0).toString(),1) ) {
